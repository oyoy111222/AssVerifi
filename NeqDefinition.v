...
(* 定义id互不相等 *)
Definition neq_id_3 (n1 n2 n3 : id) :=
 n1<>n2 /\ n1<>n3 /\ n2<>n3.

Definition neq_id_4 (n1 n2 n3 n4 : id) :=
 n1<>n2 /\ n1<>n3 /\ n1<>n4 /\ 
 n2<>n3 /\ n2<>n4 /\ n3<>n4.

Definition neq_id_5 (n1 n2 n3 n4 n5 : id):=
 n1<>n2 /\ n1<>n3 /\ n1<>n4 /\ n1<>n5 /\
 n2<>n3 /\ n2<>n4 /\ n2<>n5 /\
 n3<>n4 /\ n3<>n5 /\
 n4<>n5.

Definition neq_id_6 (n1 n2 n3 n4 n5 n6 : id):=
...
Definition neq_id_7 (n1 n2 n3 n4 n5 n6 n7 : id):=
...
Definition neq_id_8 (n1 n2 n3 n4 n5 n6 n7 n8 : id):=
...
Definition neq_id_9 (n1 n2 n3 n4 n5 n6 n7 n8 n9 : id) :=
...
Definition neq_id_10 (n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 : id):=
...
Definition neq_id_11 (n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 : id):=
...
Definition neq_id_12 (n1 n2 n3 n4 n5 n6 n7 n8 n9 n10 n11 n12 : id):=
