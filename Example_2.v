...
Definition Example_2 :=
  (o1_ZD ::=plan_ZD (Atuple4 (129;26;0;1)));;
  (P16 ::=asgn (OId o1_ZD));;
...
(emp_sO, d1 !sv-> 0; d2 !sv-> 0; gdsb_12 !sv-> 1; gdsb_13 !sv-> 1; jyc_6 !sv-> 1; jyc_17 !sv-> 1; emp_sV, 
 emp_sS, rloc_30 !hr-> 1; rloc_31 !hr-> 1; rloc_32 !hr-> 1; rloc_33 !hr-> 1;  emp_heapR, 
 emp_heapO) =[Example_2]=> Abt.
